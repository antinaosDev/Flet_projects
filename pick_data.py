...
def crear_campos():
    # Datos empresa
    num_cot = input_text_field('N° Cotización:', 'N°')
    ...
    return num_cot, nombre_v, tel_v, correo_v, dias_cot, nombre_c, tel_c, correo_c, productos, cantidades, precios

def obtener_valores(num_cot, nombre_v, tel_v,correo_v,dias_cot,nombre_c,tel_c,correo_c,productos,cantidades,precios):
    #datos empresa
    ...
    return num_cot_val, nombre_v_val, tel_v_val,correo_v_val,dias_cot_val,nombre_c_val,tel_c_val,correo_c_val,productos_val,cantidades_val,precios_val
